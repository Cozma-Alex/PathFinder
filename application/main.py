...
class PathFinderApp(QMainWindow):
    ...
    def initUI(self):
        ...
        # Status display
        self.status_label = QLabel("Select a model file or click Launch for random navigation")
    ...
    def browse_model(self):
        ...
        file_path, _ = file_dialog.getOpenFileName(
            self, "Select Navigation Model", "", "Model Files (*.pt *.pth);;All Files (*)"
        )
    ...
    def load_model(self):
        ...
        try:
            ...
            if self.model.load_state_dict(state_dict):
                ...
                self.status_label.setText("Error loading model. Using random navigation.")
    ...
    def launch_navigation(self):
        if self.load_model():
            try:
                ...
                self.navigation_window = ThorNavigationGUI(self.thor_controller, self.model)
